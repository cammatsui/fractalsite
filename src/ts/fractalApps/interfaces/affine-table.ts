...
//======================================================================================================================
    ...
    /* The HTML table which backs the AffineTable. */
     ...
     */
    public collectTransforms(): AffineTransform[] {
        let affineParams: AffineTransform[] = [];
        ...
        for (var i = 1; i < this.table.rows.length; i++) {
            ...
            affineParams.push(
                new AffineTransform(numberRow[0], numberRow[1], numberRow[2], numberRow[3], numberRow[4], numberRow[5])
            );
        }
        return affineParams;
    } // collectTransforms ()
     ...
     */
    public clear() {
        while (this.table.rows.length > 2) this.deleteLastRow();
        this.deleteLastRow();
    } // clear ()
    //==================================================================================================================
     ...
     */
    public applyPreset(transforms: AffineTransform[]) {
     ...
     * cells.
     */
    protected styleCell(cell: HTMLTableCellElement, innerText: string) {
...
//======================================================================================================================
     ...
     */
    public collectProbabilities(): number[] {
    ...
    public addRow() {
        let newRow = this.table.insertRow(this.table.rows.length);
        for (var i = 0; i < this.table.rows[0].cells.length; i++) {
            if (i == 6) this.styleCell(newRow.insertCell(i), "1");
            else this.styleCell(newRow.insertCell(i), "0"); // Insert a cell and style it to match the table.
        }
    } // addRow ()
    //==================================================================================================================
    ...
    public deleteLastRow() {
        ...
        let firstRow = this.table.rows[1];
        for (var i = 0; i < firstRow.cells.length; i++) {
            if (i == 6) this.styleCell(firstRow.cells[i], "1");
            else this.styleCell(firstRow.cells[i], "0");
        }
    } // deleteLastRow ()
    //==================================================================================================================
