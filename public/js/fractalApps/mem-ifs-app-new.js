 ...
 */
// IMPORTS
import { IFSWithMemory } from '../fractals/mem-ifs-new.js';
...
// INITIALIZATION
//======================================================================================================================
const allowedTransformations = ["22"];
...
reDraw();
var ifs = new IFSWithMemory(fractalCanvas, allowedTransformations, ifsParamSelector.is2D);
// Animation stuff
var intervalID = 0;
// For warning
var warned = false;
