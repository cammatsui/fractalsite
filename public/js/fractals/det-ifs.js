...
import { createAffineMatrix, invertAffineMatrix, combineImageDatas, getTransformedImageDataAnimatedWindow } from './utils/affine-transform.js';
//======================================================================================================================
//======================================================================================================================
/**
...
export class DeterministicIFS {
    ...
    constructor(canvas, transformParameters, a, b) {
        ...
        transformParameters.forEach(t => {
            ...
            var inverted = invertAffineMatrix(createAffineMatrix(t.r, t.s, t.theta, t.phi, t.e, t.f, this.canvas.width, this.canvas.height));
